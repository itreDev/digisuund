    ...
    <section className="pt-32 pb-20 px-4 container mx-auto hero-gradient">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none space-y-6 text-description leading-relaxed">
          ...
          <p>
            Meie veebileht salvestab oma külastajate kohta logifaile. Kogutava
            teabe hulka võib kuuluda:
          </p>
          ...
          <p>
            Nagu enamus veebilehti, kasutab ka meie veebileht "küpsiseid".
          ...
          <ul className="list-disc my-4 mx-0 pl-10 space-y-2">
            <li>
              Püsiküpsised jäävad Teie personaalarvutisse või mobiilseadmesse ka
              peale seda, kui olete sulgenud brauseri või arvuti.
            </li>
            <li>
              Sessiooniküpsised kustutatakse kohe pärast brauseri sulgemist.
            </li>
          </ul>
          ...
          <ul className="list-disc my-4 mx-0 pl-10 space-y-2">
            ...
            <li>
              <strong>Funktsionaalsuse küpsised.</strong> Need küpsised
              võimaldavad Teie brauseril meeles pidada valikuid, mida teete
              veebisaidi kasutamisel, näiteks Teie sisselogimisandmete või
              keele-eelistuste salvestamine. Nende küpsiste eesmärk on pakkuda
              Teile personaalsemat kogemust ja vältida eelistuste uuesti
              sisestamist.
            </li>
          </ul>
          ...
          <p>
            ...
            andmeid kasutatakse turvalisuse tugevdamiseks, meie teenuse
          ...
          <ul className="list-disc my-4 mx-0 pl-10 space-y-2">
            <li>
              <strong>Juurdepääsuõigus</strong> – teil on õigus nõuda oma
              isikuandmete koopiaid.
            </li>
            <li>
              <strong>Õigus andmete parandustele</strong> – teil on õigus nõuda,
            ...
            <li>
              ...
              tingimustel on teil õigus nõuda Teie isikuandmete kasutamise
              piiramist.
            </li>
            <li>
